...
func checkPorcupineApiKey(ip: String, key: String, completion: @escaping (Bool?) -> Void) {
    // URL of the API endpoint
    guard let url = URL(string: "http://\(ip):5000/test_porcupine_api_key?api_key=\(key)") else {

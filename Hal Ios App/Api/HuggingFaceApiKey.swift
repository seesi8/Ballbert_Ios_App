//
//  HuggingFaceApiKey.swift
//  Hal Ios App
//
//  Created by Sam Liebert on 7/30/23.
//

import Foundation

func checkHuggingFaceApiKey(ip: String, key: String, completion: @escaping (Bool?) -> Void) {
    // URL of the API endpoint
    guard let url = URL(string: "http://\(ip):5000/test_huggingface_api_key?api_key=\(key)") else {
